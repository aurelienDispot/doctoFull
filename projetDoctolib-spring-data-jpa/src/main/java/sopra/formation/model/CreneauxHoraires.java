...
public class CreneauxHoraires {
	...
	@OneToMany(mappedBy = "creneauxHoraires")
	private List<Practicien> practicien = new ArrayList<Practicien>();
	
	public CreneauxHoraires(Long id, Date dtDebut, List<Lieux> lieux, RendezVous rendezvous,
			List<Practicien> practicien) {
		super();
		this.id = id;
	...
	public List<Practicien> getPracticien() {
		return practicien;
	}

	public void setPracticien(List<Practicien> practicien) {
		this.practicien = practicien;
	}
